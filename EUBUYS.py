...
# Account credentials
login = 455448401 #Insert actual login here
server = 'rhifsks' #Insert actual server here
password = 'RHOSDKSS' #Insert actual Password here
...
# Select EURUSD, change to whatever symbol you want
symbol = "EURUSDz"
# feel free to change timeframes as well
...
# Calculate lot size. Change risk and commission_per_lot as you see fit
...
# Set buy stop order based on the previous candle
entry_price = previous_candle['high'] + 1 * mt5.symbol_info(symbol).point
stop_loss = previous_candle['low'] - 1 * mt5.symbol_info(symbol).point
lot_size = calculate_lot_size(entry_price, stop_loss)
order_type = mt5.ORDER_TYPE_BUY_STOP
order_comment = "Buy stop order"
